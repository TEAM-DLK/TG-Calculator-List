...
"Calculator-Bot",
    ...
    api_id="TG-BOT-OWNER-API-AD",
    api_hash="TG-BOT-OWNER-API-HASH"
)

# Constants
START_TEXT = """Hᴇʟʟᴏ {}, I ᴀᴍ ᴀ sɪᴍᴘʟᴇ, sᴍᴀʀᴛ ᴀɴᴅ Fᴀsᴛᴇsᴛ ᴄᴀʟᴄᴜʟᴀᴛᴏʀ ʙᴏᴛ, Mᴀᴅᴇ ʙʏ [Lisa](https://t.me/LisaBotUpdatez)!
I ᴄᴀɴ ᴄᴀʟᴄᴜʟᴀᴛᴇ sᴜᴍs ғᴏʀ ʏᴏᴜ! Hɪᴛ /calculator ᴛᴏ ɢᴇᴛ ᴛʜᴇ ᴍᴇɴᴜ!
[Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ](https://t.me/DevDLK) | [Sᴜᴘᴘᴏʀᴛ Cʜᴀɴɴᴇʟ](https://t.me/DOOZY_OFF)
[Mʏ Cʀᴇᴀᴛᴏʀ](https://t.me/iiiIiiiAiiiMiii)"""

CALCULATE_TEXT = "Calculator Menu 🗃"

START_BUTTONS = InlineKeyboardMarkup(
    [[InlineKeyboardButton('Join Updates Channel', url='https://telegram.me/DevDLK')]]
)
